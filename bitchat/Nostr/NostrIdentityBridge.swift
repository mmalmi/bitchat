...
final class NostrIdentityBridge {
    ...
    func clearAllAssociations() {
        ...
        deviceSeedCache = nil
        // Also drop all in-memory identities. These hold the actual private
        // keys; if left cached, post-panic messages could still be signed with
        // pre-panic keys until the app is force-quit.
        cacheLock.lock()
